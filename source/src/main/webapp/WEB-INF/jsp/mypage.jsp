...
<body>
		...
		<div class="modal">
			...
			<div class="image-list">
				<c:forEach var="icon" items="${icon}">
					<img src="<c:url value='/img/${icon.icon_name}' />"
						class="image-option" data-id="${icon.icon_id}" />
				</c:forEach>
				<br>
				<br>
			</div>
	...
	<div class="header">
		<button type="button" class="hamburger" name="humberger_menu"
			aria-label="メニュー" aria-controls="nav-menu" aria-expanded="false">
...
<!-- フレームとフォーム -->
<div class="flame">
 <div class="rectangle-label">マイページ</div> <!-- ← ラベルを追加 -->
		    ...
		    <div class="form-wrapper">
		      <form class="Form" id="registForm" method="POST" action="<c:url value='/MypageServlet' />">
		        ...
		        <div class="Form-Item">
		          ...
		          <input type="text" name="name_input" class="Form-Item-Input" id="nameInput" value="${e.user_name}" required>
		        </div>
