...
<body>
		...
		<nav id="nav-menu" class="nav" aria-hidden="true">
			<ul class="nav__list">
				<li class="nav__item"><a href="<c:url value='/HomeServlet' />"
					class="nav__link">ホーム</a></li>
				<li class="nav__item"><a
					href="<c:url value='/MypageServlet' />" class="nav__link">マイページ</a></li>
				<li class="nav__item"><a
					href="<c:url value='/CalendarServlet'/>" class="nav__link">カレンダー</a></li>
				<li class="nav__item"><a href="<c:url value='/StoreServlet'/>"
					class="nav__link">ストア</a></li>
				<li class="nav__item"><a href="<c:url value='/HelpServlet'/>"
					class="nav__link">ヘルプ</a></li>
				<li class="nav__item"><a href="<c:url value='/LogoutServlet'/>"
					class="nav__link" id="logout">ログアウト</a></li>
			</ul>
		</nav>
	</div>
			...
			<div class="rectangle">
				<div class="form-wrapper">
					<a href="${region}"> <input type="submit" name="link"
						class="link help-button" value="ゴミの出し方について">
					</a> <input type="submit" name="pointinfo"
						class="pointinfo help-button" value="ポイントについて"> <input
						type="submit" name="subject" class="subject help-button"
						value="お問い合わせ">
	...
	<div id="popup" class="popup">
		<div class="popup-content">
			<span class="popup-close" id="popup-close" role="button"
				aria-label="閉じる"></span> <img
